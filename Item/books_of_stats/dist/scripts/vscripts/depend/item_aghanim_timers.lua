...
if ItemAghanimTimers == nil then
	print ( '[Timers] creating Timers' )
	ItemAghanimTimers = {}
	ItemAghanimTimers.__index = ItemAghanimTimers
end

function ItemAghanimTimers:new( o )
	o = o or {}
	setmetatable( o, ItemAghanimTimers )
	return o
end

function ItemAghanimTimers:start()
	ItemAghanimTimers = self
	self.timers = {}
...
function ItemAghanimTimers:Think()
	...
	-- Process timers
	for k,v in pairs(ItemAghanimTimers.timers) do
		...
		if now >= v.endTime then
			...
			ItemAghanimTimers.timers[k] = nil
			...
			if status then
				...
				ItemAghanimTimers:HandleEventError('Timer', k, nextCall)
			end
		end
	end
...
function ItemAghanimTimers:HandleEventError(name, event, err)
	print(err)
...
function ItemAghanimTimers:CreateTimer(name, args)
	...
	ItemAghanimTimers.timers[name] = args

	return name
end

function ItemAghanimTimers:RemoveTimer(name)
	ItemAghanimTimers.timers[name] = nil
end

function ItemAghanimTimers:RemoveTimers(killAll)
	local timers = {}
	...
	ItemAghanimTimers.timers = timers
end

ItemAghanimTimers:start()